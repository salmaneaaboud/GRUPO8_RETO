...
public class Character {
    ...
    public Character(String characterId, String name, int mana, int health, int velocidad, int strength, int level, int experiencePoints, int valuePoints, String coins, String type) {
